...
class TreinamentoModelos:
    ...
    def modelo_gradient_boosting(self, max_depth=3, n_estimators=100, learning_rate=0.1, random_state=0):
    ...
    def modelo_xgboost(self, max_depth=3, n_estimators=100, learning_rate=0.1, random_state=0):
        return XGBRegressor(
            max_depth=max_depth,
            n_estimators=n_estimators,
            learning_rate=learning_rate,
    ...
    def treinar_regressao_linear(self, copy_X=True, n_jobs=None):
        regre_lr = self.modelo_regressao_linear(
            copy_X=copy_X,
            n_jobs=n_jobs
        )
