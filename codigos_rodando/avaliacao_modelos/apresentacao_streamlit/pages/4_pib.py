...
try:
    ...
    dados_salvos_pib = pickle.load(open(arquivo, 'rb'))
...
if "dados_salvos_pib" not in st.session_state:
    st.session_state["dados_salvos"] = dados_salvos_pib
    st.session_state['x_treino'] = dados_salvos_pib['x_treino']
    st.session_state['x_teste'] = dados_salvos_pib['x_teste']
    st.session_state['y_treino'] = dados_salvos_pib['y_treino']
    st.session_state['y_teste'] = dados_salvos_pib['y_teste']
    st.session_state['index_treino'] = dados_salvos_pib['index_treino']
    st.session_state['index_teste'] = dados_salvos_pib['index_teste']
    st.session_state['y_teste_recorrente'] = dados_salvos_pib['y_teste_recorrente']
    st.session_state['y_treino_recorrente'] = dados_salvos_pib['y_treino_recorrente']
    st.session_state['x_teste_recorrente'] = dados_salvos_pib['x_teste_recorrente']
    st.session_state['x_treino_recorrente'] = dados_salvos_pib['x_treino_recorrente']
    st.session_state['predicoes_treino'] = dados_salvos_pib['predicoes_treino']
    st.session_state['predicoes_teste'] = dados_salvos_pib['predicoes_teste']
    st.session_state['metrica_teste'] = dados_salvos_pib['metrica_teste']
    st.session_state['metrica_treino'] = dados_salvos_pib['metrica_treino']
    st.session_state['melhor_modelo'] = dados_salvos_pib['melhor_modelo']
    st.session_state['dados_conformal'] = dados_salvos_pib['dados_conformal']
    st.session_state['dados_futuro'] = dados_salvos_pib['dados_futuro']
    st.session_state['modelos_carregados'] = dados_salvos_pib['modelos_carregados']
