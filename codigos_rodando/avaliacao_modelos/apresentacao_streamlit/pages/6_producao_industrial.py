...
try:
    ...
    dados_salvos_producao_industrial = pickle.load(open(arquivo, 'rb'))
...
if "dados_salvos_producao_industrial" not in st.session_state:
    st.session_state["dados_salvos"] = dados_salvos_producao_industrial
    st.session_state['x_treino'] = dados_salvos_producao_industrial['x_treino']
    st.session_state['x_teste'] = dados_salvos_producao_industrial['x_teste']
    st.session_state['y_treino'] = dados_salvos_producao_industrial['y_treino']
    st.session_state['y_teste'] = dados_salvos_producao_industrial['y_teste']
    st.session_state['index_treino'] = dados_salvos_producao_industrial['index_treino']
    st.session_state['index_teste'] = dados_salvos_producao_industrial['index_teste']
    st.session_state['y_teste_recorrente'] = dados_salvos_producao_industrial['y_teste_recorrente']
    st.session_state['y_treino_recorrente'] = dados_salvos_producao_industrial['y_treino_recorrente']
    st.session_state['x_teste_recorrente'] = dados_salvos_producao_industrial['x_teste_recorrente']
    st.session_state['x_treino_recorrente'] = dados_salvos_producao_industrial['x_treino_recorrente']
    st.session_state['predicoes_treino'] = dados_salvos_producao_industrial['predicoes_treino']
    st.session_state['predicoes_teste'] = dados_salvos_producao_industrial['predicoes_teste']
    st.session_state['metrica_teste'] = dados_salvos_producao_industrial['metrica_teste']
    st.session_state['metrica_treino'] = dados_salvos_producao_industrial['metrica_treino']
    st.session_state['melhor_modelo'] = dados_salvos_producao_industrial['melhor_modelo']
    st.session_state['dados_conformal'] = dados_salvos_producao_industrial['dados_conformal']
    st.session_state['dados_futuro'] = dados_salvos_producao_industrial['dados_futuro']
    st.session_state['modelos_carregados'] = dados_salvos_producao_industrial['modelos_carregados']
