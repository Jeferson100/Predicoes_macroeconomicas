...
def test_treinar_xgboost(data_regressao):
    _, X_test, _, y_test, modelos = data_regressao
...
def test_treinar_catboost(data_regressao):
    _, X_test, _, y_test, modelos = data_regressao
...
def test_treinar_regressao_linear(data_regressao):
    _, X_test, _, y_test, modelos = data_regressao
